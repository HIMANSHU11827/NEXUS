...
`;
   ...
   const enrichConfigDefaults = (config: Record<string, any>) => {
      ...
      next.voice_input = {
         ...
         whisper_model: voice.whisper_model ?? 'models/local/voice/ggml-tiny-q5_1.bin',
      ...
      next.voice_output = {
         ...
         kitten_model: voice.kitten_model ?? 'KittenML/kitten-tts-nano-0.8-int8',
   ...
   const syncDerivedConfigForSave = (config: any) => {
      ...
      next.voice = {
         ...
         whisper_model: String(next.voice_input?.whisper_model ?? 'models/local/voice/ggml-tiny-q5_1.bin'),
         ...
         kitten_model: String(next.voice_output?.kitten_model ?? 'KittenML/kitten-tts-nano-0.8-int8'),
