...
class NexusPromptEngine:
    ...
    def build_super_prompt(
        cls, root_dir: str, context_map: str, role: str = "ARCHITECT", intent_hints: List[str] = None
    ) -> str:
        # 🧪 3.8: EXPERIENTIAL RECALL (Dynamic Memory Injection)
        from knowledge.vault import KnowledgeVault
        vault = KnowledgeVault(root_dir)
    ...
    def build_local_prompt(cls) -> str:
        ...
        return (
            ...
            "Project identity: NEXUS AI handles direct system control, coding workflows, RAG, memory, provider routing, tools, dashboard operations, diagnostics, rollback, and evidence logging.\n"
