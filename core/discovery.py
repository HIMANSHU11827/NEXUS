...
class NexusAutoDiscover:
    ...
    def discover_skills(self) -> List[Dict[str, str]]:
        ...
        # OpenClaw (clade) skills
        claw_skills_path = os.path.join(self.root, "external_skills", "skills")
        if os.path.exists(claw_skills_path):
            for skill_dir in os.listdir(claw_skills_path):
                full_dir = os.path.join(claw_skills_path, skill_dir)
                if os.path.isdir(full_dir):
                    ...
                    if os.path.exists(skill_md):
                        ...
                        try:
                            ...
                            pass
                        skills.append({"id": f"clade:{skill_dir}", "summary": summary})
