...
- Context building lives in `src/nexus/main_agent/grounding.py` (`V5ContextGrounding` mixin) and `src/nexus/main_agent/compat.py`
...
All context sources loaded concurrently in `_ground_context()` (`src/nexus/main_agent/grounding.py`):
