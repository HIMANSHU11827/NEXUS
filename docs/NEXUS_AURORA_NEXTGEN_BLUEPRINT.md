# NEXUS AURORA Next-Gen Blueprint
...
can become code, tests, dashboard state, or benchmark cases.
...
9. Dashboard state must be honest, not aspirational.
...
93. Swarm Checkpointing: pause/resume long multi-agent missions.
94. Swarm Merge Judge: merge conflicting agent results.
...
108. Rollback Browser: inspect and restore snapshots from dashboard.
...
112. Repo Weather Dashboard: risk heatmap.
113. Memory Graph Viewer: inspect memory nodes and links.
114. Tool Market Dashboard: tool success/risk/latency.
...
120. Failure Vaccine Dashboard: regressions generated from failures.

## Implementation Phases

### Phase 1: Make Current NEXUS Smarter

- Add mission replay. `[started: core/aurora/mission_replay.py]`
- Add tool economy telemetry. `[started: core/aurora/tool_economy.py]`
- Add test selection engine. `[started: core/aurora/test_selection.py]`
- Add failure vaccine engine. `[started: core/aurora/failure_vaccine.py]`
...
13. Dashboard benchmark history panel.
14. Dashboard rollback browser.
...
- Do not add dashboard cards that show fake active systems.
