...
See `docs/NEXUS_AURORA_NEXTGEN_BLUEPRINT.md` for the broader research-backed
...
- Dashboard request audit viewer.
...
Build the best local-first autonomous engineering operating system: fast direct execution, deep project memory, repo consciousness, safe-by-design command power, and an operator-grade dashboard.
