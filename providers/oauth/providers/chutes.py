...
CLIENT_ID = "chutes"
AUTHORIZE_URL = "https://chutes.ai/oauth/authorize"
TOKEN_URL = "https://chutes.ai/oauth/token"
CALLBACK_PORT = 9090
...
async def login_chutes(
    ...
    try:
        ...
        logger.warning("providers/oauth/providers/chutes.py: suppressed error in login_chutes", exc_info=True)
        pass
...
def refresh_chutes_token(refresh_token: str) -> OAuthCredentials:
