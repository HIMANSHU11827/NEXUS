...
CLIENT_ID = "grok"
AUTHORIZE_URL = "https://oauth.x.ai/authorize"
TOKEN_URL = "https://oauth.x.ai/token"
CALLBACK_PORT = 56121
...
async def login_grok(
    ...
    try:
        ...
        logger.warning("providers/oauth/providers/grok.py: suppressed error in login_grok", exc_info=True)
        pass
...
def refresh_grok_token(refresh_token: str) -> OAuthCredentials:
