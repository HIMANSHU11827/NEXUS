...
AUTHORIZE_URL = "https://chatgpt.com/api/auth/oauth/authorize"
TOKEN_URL = "https://chatgpt.com/api/auth/oauth/token"
CALLBACK_PORT = 1455
...
def refresh_codex_token(refresh_token: str) -> OAuthCredentials:
