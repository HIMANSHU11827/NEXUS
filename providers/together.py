...
class TogetherProvider(NexusBaseProvider):
    ...
    def __init__(self):
        ...
        if not self.model:
            self.model = os.environ.get("NEXUS_PROVIDER_TOGETHER_MODEL", "meta-llama/Llama-3-70b-chat-hf")
        self.headers = {
        ...
        try:
            ...
            if response is not None:
                try:
                    ...
                    logger.debug("Together stream response cleanup failed", exc_info=True)
