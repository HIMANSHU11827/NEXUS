...
metadata:
  NEXUS:
    ...
    related_skills: [claude-code, NEXUS-agent]
---

# Codex CLI

Delegate coding tasks to [Codex](https://github.com/openai/codex) via the NEXUS terminal. Codex is OpenAI's autonomous coding agent CLI.
