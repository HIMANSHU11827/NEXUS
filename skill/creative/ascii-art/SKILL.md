...
```bash
python3 -m pyfiglet "NEXUS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=NEXUS&font=Slant" | boxes -d stone
```
