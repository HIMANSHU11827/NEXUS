...
Built for [NEXUS Agent](https://github.com/NousResearch/NEXUS-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/NEXUS-agent/skills/creative/ascii-video`](https://github.com/NousResearch/NEXUS-agent/tree/main/skills/creative/ascii-video) via PR.
