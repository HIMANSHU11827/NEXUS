...
from nexus.common.nexus_compat import import_requests, itail, s, safe_round
...
class NexusKernel(ThreadSafeSingleton):
    ...
    def persistence(self):
        from nexus.context.persistence import NexusFilePersistence
        return NexusFilePersistence(self.root)

    @_register("hal")
    def hal(self):
        from models.hardware.manager import NexusHardwareManager
    ...
    @_register("trainer")
    def trainer(self):
        from models.neural.trainer import NexusTrainer
    ...
    @_register("prover")
    def prover(self):
        from security.policies.prover import LogicProver
    ...
    @_register("telemetry")
    def telemetry(self):
        from nexus.runtime.kernel.telemetry import NexusTelemetryDB
    ...
    def _lifecycle_stage_names(self) -> Dict[str, str]:
        ...
        if cache is not None:
            return cache
        try:
            from nexus.lifecycle.managers.supervisor import LifecycleStage
