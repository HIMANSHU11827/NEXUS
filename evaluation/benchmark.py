...
class BenchmarkRunner:
    ...
    DEFAULT_CASES = [
        BenchmarkCase("compile-core", "python -m compileall -q core orchestrators tools rag knowledge utils gui\\api.py nexus.py shell.py"),
        BenchmarkCase("diagnostics-core", "python -c \"from code_intel.diagnostics import DiagnosticRunner; import sys; r=DiagnosticRunner('.').run(paths=['core','tools/nexus_tools','rag','orchestrators','configs']); print(r); sys.exit(0 if r['ok'] else 1)\""),
        BenchmarkCase("sandbox-tests", "python tests\\test_sandbox.py", "OK"),
        ...
        BenchmarkCase("gui-security-tests", "python tests\\test_gui_security.py", "OK"),
        ...
        BenchmarkCase("gui-build", "cd gui && npm run build", "built", timeout=60),
    ]
