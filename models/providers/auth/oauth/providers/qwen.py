...
CLIENT_ID = "qwen"
AUTHORIZE_URL = "https://oauth.aliyun.com/v1/authorize"
...
async def login_qwen(
    ...
    try:
        ...
        logger.warning("providers/oauth/providers/qwen.py: suppressed error in login_qwen", exc_info=True)
        pass
...
def refresh_qwen_token(refresh_token: str) -> OAuthCredentials:
