...
MAPPINGS = {
    "openrouter": ("models.providers.api.openrouter", "OpenRouterProvider"),
    "nvidia": ("models.providers.api.nvidia", "NvidiaProvider"),
    "gemini": ("models.providers.api.google_gemini", "GoogleGeminiProvider"),
    "google_gemini": ("models.providers.api.google_gemini", "GoogleGeminiProvider"),
    "anthropic": ("models.providers.api.anthropic", "AnthropicProvider"),
    "openai": ("models.providers.api.openai", "OpenAIProvider"),
    "groq": ("models.providers.api.groq", "GroqProvider"),
    "qwen": ("models.providers.api.qwen", "QwenProvider"),
    "deepseek": ("models.providers.api.deepseek", "DeepSeekProvider"),
    "xai": ("models.providers.api.xai", "XAIProvider"),
    "grok": ("models.providers.api.xai", "XAIProvider"),
    "cohere": ("models.providers.api.cohere", "CohereProvider"),
    "mistral": ("models.providers.api.mistral", "MistralProvider"),
    "perplexity": ("models.providers.api.perplexity", "PerplexityProvider"),
    "together": ("models.providers.api.together", "TogetherProvider"),
    "lm_studio": ("models.providers.local.lm_studio", "LMStudioProvider"),
    "ollama": ("models.providers.local.ollama", "OllamaProvider"),
    "huggingface": ("models.providers.api.huggingface", "HuggingFaceProvider"),
    "sambanova": ("models.providers.api.sambanova", "SambaNovaProvider"),
    "fireworks": ("models.providers.api.fireworks", "FireworksProvider"),
    "azure_openai": ("models.providers.api.azure_openai", "AzureOpenAIProvider"),
    "replicate": ("models.providers.api.replicate", "ReplicateProvider"),
    "llama_cpp": ("models.providers.local.llama_cpp", "LlamaCPPProvider"),
    "zupra": ("models.providers.api.zupra", "ZupraProvider"),
    "vlm": ("models.providers.core.vlm", "VLMProvider"),
    "universal": ("models.providers.core.universal", "UniversalProvider"),
    "commandcode": ("models.providers.api.commandcode", "CommandCodeProvider"),
    # OpenAI-compatible API-key providers route through universal
    "deepinfra": ("models.providers.core.universal", "UniversalProvider"),
    "cerebras": ("models.providers.core.universal", "UniversalProvider"),
    "moonshot": ("models.providers.core.universal", "UniversalProvider"),
    "kimi": ("models.providers.core.universal", "UniversalProvider"),
    "stepfun": ("models.providers.core.universal", "UniversalProvider"),
    "zai": ("models.providers.core.universal", "UniversalProvider"),
    "venice": ("models.providers.core.universal", "UniversalProvider"),
    "novita": ("models.providers.core.universal", "UniversalProvider"),
    "byteplus": ("models.providers.core.universal", "UniversalProvider"),
    "volcengine": ("models.providers.core.universal", "UniversalProvider"),
    "arcee": ("models.providers.core.universal", "UniversalProvider"),
    "cloudflare_ai_gateway": ("models.providers.core.universal", "UniversalProvider"),
    "vercel_ai_gateway": ("models.providers.core.universal", "UniversalProvider"),
    "tencent_tokenhub": ("models.providers.core.universal", "UniversalProvider"),
    "qianfan": ("models.providers.core.universal", "UniversalProvider"),
    "litellm": ("models.providers.core.universal", "UniversalProvider"),
    "opencode": ("models.providers.auth.opencode_cli", "OpenCodeCLIProvider"),
    "fal": ("models.providers.core.universal", "UniversalProvider"),
    "vydra": ("models.providers.core.universal", "UniversalProvider"),
    "synthetic": ("models.providers.core.universal", "UniversalProvider"),
    "gmi": ("models.providers.core.universal", "UniversalProvider"),
    "copilot_proxy": ("models.providers.core.universal", "UniversalProvider"),
    "vllm": ("models.providers.core.universal", "UniversalProvider"),
    "sglang": ("models.providers.core.universal", "UniversalProvider"),
    # OAuth-compatible providers
    "codex": ("models.providers.core.universal", "UniversalProvider"),
    "claude": ("models.providers.core.universal", "UniversalProvider"),
    "github_copilot": ("models.providers.core.universal", "UniversalProvider"),
    "minimax": ("models.providers.core.universal", "UniversalProvider"),
    "chutes": ("models.providers.core.universal", "UniversalProvider"),
}
    ...
    def _load_provider_instance(self, target_name: str) -> Any:
        ...
        for _cat in ("local", "api", "auth", "core"):
            ...
            try:
                ...
                continue
        if mod_name is None:
            mod_name = f"models.providers.api.{target}"
