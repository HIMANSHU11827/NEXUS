...
import type {parseArguments} from './bin/nexus-omni-cli-options.js';
...
export const logDisclaimers = (args: ReturnType<typeof parseArguments>) => {
  console.error(
    `NEXUS Browser Bridge exposes browser content to agentic controllers.
Ensure you are operating in a safe environment when processing sensitive data.`,
  );
...
For more details, visit: https://github.com/ChromeDevTools/nexus-omni#usage-statistics`,
    );
  }
};
