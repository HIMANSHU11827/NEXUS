...
class MemoryForge:
    ...
    def forge(self, title: str, content: str = "", importance: int = 5, tags: List[str] = None) -> Dict[str, Any]:
        ...
        mem = {"title": title, "content": content, "importance": importance, "tags": tags, "version": "1.0", "created_at": time.time(), "updated_at": time.time()}
        ...
        return {"created": True, "name": safe_name, "version": "1.0", "path": path}
