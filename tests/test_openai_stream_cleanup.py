...
@pytest.mark.parametrize(
    ...
    [
        ("models.providers.api.groq", "GroqProvider"),
        ("models.providers.api.xai", "XAIProvider"),
        ("models.providers.api.together", "TogetherProvider"),
        ("models.providers.api.fireworks", "FireworksProvider"),
        ("models.providers.api.mistral", "MistralProvider"),
        ("models.providers.local.lm_studio", "LMStudioProvider"),
        ("models.providers.core.universal", "UniversalProvider"),
        ("models.providers.api.qwen", "QwenProvider"),
        ("models.providers.api.perplexity", "PerplexityProvider"),
        ("models.providers.api.sambanova", "SambaNovaProvider"),
        ("models.providers.api.azure_openai", "AzureOpenAIProvider"),
        ("models.providers.api.cohere", "CohereProvider"),
        ("models.providers.api.nvidia", "NvidiaProvider"),
    ],
)
